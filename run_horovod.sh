...
HOROVOD_TIMELINE=/home/rashid/DistributedCNN/horovod_timeline_1worker.json /home/rashid/mpi3/bin/mpirun -np 1 \
    -H 192.168.1.29:1 \
    -bind-to none -map-by slot \
    -x NCCL_DEBUG=INFO -x LD_LIBRARY_PATH -x PATH \
    --mca oob_tcp_if_include br0 --mca btl_tcp_if_include br0 -x NCCL_SOCKET_IFNAME=br0 \
    /home/rashid/.conda/envs/dnn/bin/python /home/rashid/DistributedCNN/distributed_train_horovod.py -i "/data/mounted_hdfs_path/user/hduser/mrc689/Sampled_Dataset" -gt "/data/mounted_hdfs_path/user/hduser/mrc689/Sampled_Dataset_GT/density_map/xavier" -ckpt_path "/discus/P2IRC/rashid/tf_ckpt" -nw 1
...
#    -x NCCL_DEBUG=INFO -x LD_LIBRARY_PATH -x PATH \
#    --mca oob_tcp_if_include br0 --mca btl_tcp_if_include br0 -x NCCL_SOCKET_IFNAME=br0 \
#    /home/rashid/.conda/envs/dnn/bin/python /home/rashid/DistributedCNN/distributed_train_horovod.py -i "/data/mounted_hdfs_path/user/hduser/mrc689/Sampled_Dataset" -gt "/data/mounted_hdfs_path/user/hduser/mrc689/Sampled_Dataset_GT/density_map/xavier" -ckpt_path "/discus/P2IRC/rashid/tf_ckpt" -nw 2


#HOROVOD_TIMELINE=/home/rashid/DistributedCNN/Model/horovod_timeline_4workers.json /home/rashid/mpi3/bin/mpirun -np 4 \
